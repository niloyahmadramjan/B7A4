...
export type AvailabilityOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "technicianId" | "dayOfWeek" | "startTime" | "endTime" | "isAvailable", ExtArgs["result"]["availability"]>;
